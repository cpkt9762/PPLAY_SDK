...
public:
	...
	class UTslGameInstance*                            TslGameInstance;                                          // 0x0068(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
...
public:
	...
	class AWeaponProcessor*                            TemporaryWeaponProcessor;                                 // 0x07D8(0x0008) (ZeroConstructor, IsPlainOldData)
...
public:
	...
	struct FStringAssetReference                       TencentMapTexture;                                        // 0x03D0(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly)
...
{
public:
	bool                                               bSpawnBulletFromBarrel;                                   // 0x07E0(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x7];                                       // 0x07E1(0x0007) MISSED OFFSET
	class UAkAudioEvent*                               VariableZoomStepAk;                                       // 0x07E8(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class UAkAudioEvent*                               ZeroingStepAk;                                            // 0x07F0(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x07F8(0x0004) MISSED OFFSET
	int                                                AmmoPerClip;                                              // 0x07FC(0x0004) (Net, ZeroConstructor, Transient, IsPlainOldData)
	int                                                CurrentAmmoInClip;                                        // 0x0800(0x0004) (Net, ZeroConstructor, Transient, IsPlainOldData)
	int                                                CurrentZeroLevel;                                         // 0x0804(0x0004) (Net, ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      bIsHipped : 1;                                            // 0x0808(0x0001) (Net, Transient)
	unsigned char                                      UnknownData02[0x3];                                       // 0x0809(0x0003) MISSED OFFSET
	float                                              TimeBetweenShots;                                         // 0x080C(0x0004) (Net, ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      UnknownData03[0x28];                                      // 0x0810(0x0028) MISSED OFFSET
	int                                                FiringModeIndex;                                          // 0x0838(0x0004) (Net, ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      UnknownData04[0x84];                                      // 0x083C(0x0084) MISSED OFFSET
	struct FWeaponGunData                              WeaponGunConfig;                                          // 0x08C0(0x0090) (Edit, DisableEditOnInstance)
	struct FWeaponDeviationData                        WeaponDeviationConfig;                                    // 0x0950(0x0044) (Edit, DisableEditOnInstance)
	unsigned char                                      UnknownData05[0x4];                                       // 0x0994(0x0004) MISSED OFFSET
	struct FWeaponGunAnim                              WeaponGunAnim;                                            // 0x0998(0x00F0) (Edit, DisableEditOnInstance)
	struct FWeaponPPSettings                           WeaponGunPostprocessSettings;                             // 0x0A88(0x0050) (Edit, DisableEditOnInstance)
	struct FName                                       ScopingAttachPoint;                                       // 0x0AD8(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	struct FName                                       ScopingFocusPoint;                                        // 0x0AE0(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               bLoackLoadedAmmo;                                         // 0x0AE8(0x0001) (ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      UnknownData06[0x7];                                       // 0x0AE9(0x0007) MISSED OFFSET
...
public:
	...
	float                                              AimoffsetsLastRepTime;                                    // 0x0EC0(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData32[0x2C];                                      // 0x0EC4(0x002C) MISSED OFFSET
	struct FRotator                                    CurrentAutoRotator;                                       // 0x0EF0(0x000C) (Edit, DisableEditOnInstance, IsPlainOldData)
	float                                              AutoPitchValueMax;                                        // 0x0EFC(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              AutoPitchBlendSpeed;                                      // 0x0F00(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData33[0xC];                                       // 0x0F04(0x000C) MISSED OFFSET
	class UCurveFloat*                                 Curve_JumpCamera;                                         // 0x0F10(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class UCurveVector*                                Curve_FPPCameraOffsetByFOV;                               // 0x0F18(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class UCurveFloat*                                 Curve_DBNOFadeOut;                                        // 0x0F20(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              DBNOFadeOutLerpSpeed;                                     // 0x0F28(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData34[0x4];                                       // 0x0F2C(0x0004) MISSED OFFSET
	class UCurveFloat*                                 Curve_StandWalk;                                          // 0x0F30(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class UCurveFloat*                                 Curve_StandRun;                                           // 0x0F38(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class UCurveFloat*                                 Curve_StandSprint;                                        // 0x0F40(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class UCurveFloat*                                 Curve_CrouchWalk;                                         // 0x0F48(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class UCurveFloat*                                 Curve_CrouchRun;                                          // 0x0F50(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class UCurveFloat*                                 Curve_CrouchSprint;                                       // 0x0F58(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class UCurveFloat*                                 Curve_ProneWalk;                                          // 0x0F60(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class UCurveFloat*                                 Curve_ProneRun;                                           // 0x0F68(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class UCurveFloat*                                 Curve_ProneSprint;                                        // 0x0F70(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class UCurveFloat*                                 Curve_Swim;                                               // 0x0F78(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class UCurveFloat*                                 Curve_UnderwaterSwim;                                     // 0x0F80(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class UCurveFloat*                                 Curve_StandScope;                                         // 0x0F88(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class UCurveFloat*                                 Curve_CrouchScope;                                        // 0x0F90(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class UCurveFloat*                                 Curve_ProneScope;                                         // 0x0F98(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class UCurveFloat*                                 Curve_StandAim;                                           // 0x0FA0(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class UCurveFloat*                                 Curve_CrouchAim;                                          // 0x0FA8(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class UCurveFloat*                                 Curve_ProneAim;                                           // 0x0FB0(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class UCurveFloat*                                 Curve_DBNO;                                               // 0x0FB8(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class UCurveFloat*                                 Curve_GroundAngle;                                        // 0x0FC0(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class UCurveVector*                                Curve_WeaponSway;                                         // 0x0FC8(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class UCurveFloat*                                 Curve_TurningLerp;                                        // 0x0FD0(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class UCurveFloat*                                 Curve_TurningLerpLocomotion;                              // 0x0FD8(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              DirectionalSpeedModifier;                                 // 0x0FE0(0x0004) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	float                                              PointDamageForceMultiplier;                               // 0x0FE4(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              PointDamageForce_MapMin;                                  // 0x0FE8(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              PointDamageForce_MapMax;                                  // 0x0FEC(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              RadialDamageForceMultiplier;                              // 0x0FF0(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	TEnumAsByte<ERadialImpulseFalloff>                 RadialDamageFalloffType;                                  // 0x0FF4(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData35[0x3];                                       // 0x0FF5(0x0003) MISSED OFFSET
	class UAnimMontage*                                RollLeftAnim;                                             // 0x0FF8(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class UAnimMontage*                                RollRightAnim;                                            // 0x1000(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	struct FCharacterAnim                              CharacterAnim;                                            // 0x1008(0x0010) (Edit, DisableEditOnInstance)
	class AController*                                 NetOwnerController;                                       // 0x1018(0x0008) (Net, ZeroConstructor, Transient, IsPlainOldData)
	float                                              LeanAlphaSpeed;                                           // 0x1020(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              TurnSpeedHip;                                             // 0x1024(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              TurnSpeedAimed;                                           // 0x1028(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              TurnSpeedOverLimit;                                       // 0x102C(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              MinTurnAngleHip;                                          // 0x1030(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              MinTurnAngleAim;                                          // 0x1034(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              TurnLinearEndThreshold;                                   // 0x1038(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               bNonLinearTurn;                                           // 0x103C(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData36[0x3];                                       // 0x103D(0x0003) MISSED OFFSET
	float                                              TurnNonLinearEndThreshold;                                // 0x1040(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              TurnNonLinearInterpSpeed;                                 // 0x1044(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              CapsuleTurnInterpSpeedLocomotion;                         // 0x1048(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              CapsuleTurnInterpSpeedLocomotionSprint;                   // 0x104C(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              CapsuleTurnInterpSpeedLocomotionProne;                    // 0x1050(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              CapsuleTurnInterpSpeedStationary;                         // 0x1054(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData37[0x18];                                      // 0x1058(0x0018) MISSED OFFSET
	struct FName                                       FPPCameraBoneName;                                        // 0x1070(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	struct FName                                       TPPCameraBoneName;                                        // 0x1078(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData38[0xC];                                       // 0x1080(0x000C) MISSED OFFSET
	float                                              AimStateDefaultTime;                                      // 0x108C(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              AimStateReturnTime;                                       // 0x1090(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              AimStateDrawTime;                                         // 0x1094(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData39[0x8];                                       // 0x1098(0x0008) MISSED OFFSET
	bool                                               bAimStateActive;                                          // 0x10A0(0x0001) (BlueprintVisible, BlueprintReadOnly, Net, ZeroConstructor, IsPlainOldData)
	bool                                               bFreeMode;                                                // 0x10A1(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData40[0x6];                                       // 0x10A2(0x0006) MISSED OFFSET
	float                                              CanGroggyDamageTime;                                      // 0x10A8(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData41[0x4];                                       // 0x10AC(0x0004) MISSED OFFSET
	struct FText                                       GroggyStartText;                                          // 0x10B0(0x0018) (Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance)
	struct FText                                       GroggyCancelText;                                         // 0x10C8(0x0018) (Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance)
	struct FText                                       GroggyFinishText;                                         // 0x10E0(0x0018) (Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance)
	float                                              GamepadRunningValue;                                      // 0x10F8(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData42[0xC];                                       // 0x10FC(0x000C) MISSED OFFSET
	struct FRotator                                    BlendTargetViewRotation;                                  // 0x1108(0x000C) (Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, IsPlainOldData)
	struct FVector2D                                   DesiredDirection;                                         // 0x1114(0x0008) (BlueprintVisible, BlueprintReadOnly, IsPlainOldData)
	unsigned char                                      UnknownData43[0x4];                                       // 0x111C(0x0004) MISSED OFFSET
	class UClass*                                      InvulnerablilityBuff;                                     // 0x1120(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               bInvulnerablilityEffectVisible;                           // 0x1128(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData44[0x7];                                       // 0x1129(0x0007) MISSED OFFSET
	TArray<class UClass*>                              ComponentsToDestroyOnDedicatedServer;                     // 0x1130(0x0010) (Edit, ZeroConstructor, DisableEditOnInstance)
	TArray<struct FZombieCustomizationData>            ZombieCustomizationData;                                  // 0x1140(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	bool                                               bIsHoldingBreath;                                         // 0x1150(0x0001) (Edit, BlueprintVisible, Net, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData45[0x3];                                       // 0x1151(0x0003) MISSED OFFSET
	float                                              Health;                                                   // 0x1154(0x0004) (Edit, BlueprintVisible, Net, ZeroConstructor, IsPlainOldData)
	float                                              HealthMax;                                                // 0x1158(0x0004) (Edit, BlueprintVisible, Net, ZeroConstructor, IsPlainOldData)
	float                                              GroggyHealth;                                             // 0x115C(0x0004) (Edit, BlueprintVisible, Net, ZeroConstructor, IsPlainOldData)
	float                                              GroggyHealthMax;                                          // 0x1160(0x0004) (Edit, BlueprintVisible, Net, ZeroConstructor, IsPlainOldData)
	float                                              DecreaseGroggyHealthPerSecond;                            // 0x1164(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              GroggyDamageWeight;                                       // 0x1168(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData46[0x4];                                       // 0x116C(0x0004) MISSED OFFSET
	class UClass*                                      GroggyDamageType;                                         // 0x1170(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              HealthByRevive;                                           // 0x1178(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData47[0x4];                                       // 0x117C(0x0004) MISSED OFFSET
	class UAkAudioEvent*                               GroggyToDieAkEvent;                                       // 0x1180(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              BoostGauge;                                               // 0x1188(0x0004) (Edit, BlueprintVisible, Net, ZeroConstructor, IsPlainOldData)
	float                                              BoostGaugeMax;                                            // 0x118C(0x0004) (Edit, BlueprintVisible, Net, ZeroConstructor, IsPlainOldData)
	float                                              DecreaseTimerSecond;                                      // 0x1190(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              DecreaseBoostGaugeByTime;                                 // 0x1194(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TArray<struct FBuffWithBoostGauge>                 BuffWithBoostGauge;                                       // 0x1198(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	class UClass*                                      MedKitClass;                                              // 0x11A8(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UClass*                                      FirstAidClass;                                            // 0x11B0(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UClass*                                      BandageClass;                                             // 0x11B8(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UClass*                                      AdrenalineClass;                                          // 0x11C0(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UClass*                                      PainKillerClass;                                          // 0x11C8(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UClass*                                      EnergyDrinkClass;                                         // 0x11D0(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TArray<class UClass*>                              BoostItemClasses;                                         // 0x11D8(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	TArray<class UClass*>                              HealItemClasses;                                          // 0x11E8(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	class UClass*                                      GrenadeClass;                                             // 0x11F8(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UClass*                                      MolotovClass;                                             // 0x1200(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UClass*                                      SmokeBombClass;                                           // 0x1208(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UClass*                                      FlashBangClass;                                           // 0x1210(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData48[0x4];                                       // 0x1218(0x0004) MISSED OFFSET
	TWeakObjectPtr<class ATslPlayerState>              LaunchInstigator;                                         // 0x121C(0x0008) (ZeroConstructor, IsPlainOldData)
	TWeakObjectPtr<class AActor>                       LaunchCauser;                                             // 0x1224(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData49[0x4];                                       // 0x122C(0x0004) MISSED OFFSET
	class UClass*                                      LaunchDamageTypeClass;                                    // 0x1230(0x0008) (ZeroConstructor, IsPlainOldData)
	double                                             LastLaunchTime;                                           // 0x1238(0x0008) (ZeroConstructor, IsPlainOldData)
	class APlayerState*                                AuthorizedPlayerState;                                    // 0x1240(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
	EEquipableItemSoundType                            ShoesSoundType;                                           // 0x1248(0x0001) (Net, ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      UnknownData50[0x7];                                       // 0x1249(0x0007) MISSED OFFSET
	class UInteractorComponent*                        InteractorComponent;                                      // 0x1250(0x0008) (Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData)
	class UInteractionComponent*                       InteractionComponent;                                     // 0x1258(0x0008) (Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData)
	unsigned char                                      UnknownData51[0x18];                                      // 0x1260(0x0018) MISSED OFFSET
	class UVehicleRiderComponent*                      VehicleRiderComponent;                                    // 0x1278(0x0008) (Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, Net, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData)
	class UClass*                                      OutSidePlayerAreaEffectClass;                             // 0x1280(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class ATslPostProcessEffect*                       OutSidePlayerAreaEffect;                                  // 0x1288(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
	class UClass*                                      DBNOEffectClass;                                          // 0x1290(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class ATslPostProcessEffect*                       DBNOEffect;                                               // 0x1298(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData52[0x1E0];                                     // 0x12A0(0x01E0) MISSED OFFSET
	class USkeletalMeshComponent*                      ShadowMesh;                                               // 0x1480(0x0008) (ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData)
	float                                              TargetingFOV;                                             // 0x1488(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              AimingDelay;                                              // 0x148C(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData53[0x8];                                       // 0x1490(0x0008) MISSED OFFSET
	float                                              AttackStateOffDelayTime;                                  // 0x1498(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              HitStateOffDelayTime;                                     // 0x149C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              HitMePlayerStateOffDelayTime;                             // 0x14A0(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData54[0x34];                                      // 0x14A4(0x0034) MISSED OFFSET
	class UTslPlayerDamageConfig*                      DamageConfig;                                             // 0x14D8(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData55[0x4];                                       // 0x14E0(0x0004) MISSED OFFSET
	float                                              FallDamageFactor;                                         // 0x14E4(0x0004) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Config, IsPlainOldData)
	float                                              FallDamageVelocityMin;                                    // 0x14E8(0x0004) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Config, IsPlainOldData)
	bool                                               bIsActiveRagdollActive;                                   // 0x14EC(0x0001) (Net, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData56[0x3];                                       // 0x14ED(0x0003) MISSED OFFSET
	float                                              CorpseLifeSpan;                                           // 0x14F0(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData57[0xAC];                                      // 0x14F4(0x00AC) MISSED OFFSET
	TEnumAsByte<EStanceMode>                           PreReplicatedStanceMode;                                  // 0x15A0(0x0001) (Net, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData58[0x3];                                       // 0x15A1(0x0003) MISSED OFFSET
	struct FVector                                     JumpStartLocation_CP;                                     // 0x15A4(0x000C) (Edit, BlueprintVisible, DisableEditOnInstance, IsPlainOldData)
	struct FVector                                     LandPredictedLocation_CP;                                 // 0x15B0(0x000C) (Edit, BlueprintVisible, DisableEditOnInstance, IsPlainOldData)
	float                                              FallHeight_CP;                                            // 0x15BC(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               bIsVaulting_CP;                                           // 0x15C0(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData59[0x3];                                       // 0x15C1(0x0003) MISSED OFFSET
	float                                              VaultTimer_CP;                                            // 0x15C4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	struct FVector                                     VaultEndVelocity_CP;                                      // 0x15C8(0x000C) (Edit, BlueprintVisible, DisableEditOnInstance, IsPlainOldData)
	struct FVector                                     VaultLastLocation_CP;                                     // 0x15D4(0x000C) (Edit, BlueprintVisible, DisableEditOnInstance, IsPlainOldData)
	bool                                               bIsClimbing_CP;                                           // 0x15E0(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               bEndVaultToFall_CP;                                       // 0x15E1(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData60[0x2];                                       // 0x15E2(0x0002) MISSED OFFSET
	struct FVector                                     VaultEndVelocityVectorMutliplier;                         // 0x15E4(0x000C) (Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, IsPlainOldData)
	float                                              VaultEndVelocityVectorClamp;                              // 0x15F0(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData61[0x4];                                       // 0x15F4(0x0004) MISSED OFFSET
	class ATslVaultingHelper*                          VaultingHelperRef;                                        // 0x15F8(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, EditConst, IsPlainOldData)
	bool                                               bIsVaultingSystemEnabled;                                 // 0x1600(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData62[0x3];                                       // 0x1601(0x0003) MISSED OFFSET
	float                                              VaultingDirection_CP;                                     // 0x1604(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, EditConst, IsPlainOldData)
	class UVaultingData*                               CurrentVaultData_CP;                                      // 0x1608(0x0008) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               bServerFinishedVault;                                     // 0x1610(0x0001) (BlueprintVisible, BlueprintReadOnly, Net, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData63[0x3];                                       // 0x1611(0x0003) MISSED OFFSET
	float                                              JumpDelay;                                                // 0x1614(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              JumpLastTimer;                                            // 0x1618(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               bWantsToVault;                                            // 0x161C(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               bWantsToCancelVault;                                      // 0x161D(0x0001) (Net, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData64[0x2];                                       // 0x161E(0x0002) MISSED OFFSET
	float                                              VaultProbeLoopTime;                                       // 0x1620(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              GamepadReloadHoldTime;                                    // 0x1624(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	struct FTimerHandle                                TimerHandle_GamepadReloadHold;                            // 0x1628(0x0008)
	struct FAnimUpdateRateSettings                     AnimationUpdateRateSettings;                              // 0x1630(0x0078) (Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance)
	float                                              TO_CulledMovementTickrate;                                // 0x16A8(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              TO_CulledActorTickInterval;                               // 0x16AC(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              TO_MinimumDistance;                                       // 0x16B0(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               bRunTickOptimization;                                     // 0x16B4(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               bRunTickOptimization_Anim;                                // 0x16B5(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               bRunTickOptimization_Movement;                            // 0x16B6(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData65[0x1];                                       // 0x16B7(0x0001) MISSED OFFSET
	float                                              TO_RenderedTolerance;                                     // 0x16B8(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               bTickOptimization_Move_Active;                            // 0x16BC(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData)
	bool                                               bTickOptimization_Anim_Active;                            // 0x16BD(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData)
	bool                                               bTickOptimization_Actor_Active;                           // 0x16BE(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      UnknownData66[0x5];                                       // 0x16BF(0x0005) MISSED OFFSET
	float                                              GamepadUnarmHoldTime;                                     // 0x16C4(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              GamepadNextGunWeaponTabMaxTime;                           // 0x16C8(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData67[0x49];                                      // 0x16CC(0x0049) MISSED OFFSET
	bool                                               bIsDemoVaulting_CP;                                       // 0x1715(0x0001) (Net, ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      UnknownData68[0xA];                                       // 0x1716(0x000A) MISSED OFFSET
	class UBluezoneInOutComponent*                     BluezoneInOut;                                            // 0x1720(0x0008) (Edit, ExportObject, ZeroConstructor, Transient, DisableEditOnInstance, InstancedReference, IsPlainOldData)
	class UBluezoneInOutSoundEffectComponent*          BluezoneInOutSoundEffect;                                 // 0x1728(0x0008) (Edit, ExportObject, ZeroConstructor, Transient, DisableEditOnInstance, InstancedReference, IsPlainOldData)
	class UGamePadInputAixsComponent*                  GamePadInputAixsComponent;                                // 0x1730(0x0008) (Edit, ExportObject, ZeroConstructor, Transient, DisableEditOnInstance, InstancedReference, IsPlainOldData)
	unsigned char                                      UnknownData69[0x8];                                       // 0x1738(0x0008) MISSED OFFSET
...
public:
	...
	class UCurveFloat*                                 WidgetCurve;                                              // 0x0250(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UCurveFloat*                                 AnchorCurve;                                              // 0x0258(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
public:
	...
	class UParachuteVehicleMovement*                   ParachuteMovementComponent;                               // 0x0488(0x0008) (Edit, ExportObject, ZeroConstructor, DisableEditOnInstance, EditConst, InstancedReference, IsPlainOldData)
	class UFreeFallMovement*                           FreeFallMovementComponent;                                // 0x0490(0x0008) (Edit, ExportObject, ZeroConstructor, DisableEditOnInstance, EditConst, InstancedReference, IsPlainOldData)
	class UTslVehicleSeatComponent*                    VehicleSeatComponent;                                     // 0x0498(0x0008) (Edit, ExportObject, ZeroConstructor, DisableEditOnInstance, EditConst, InstancedReference, IsPlainOldData)
	class UDoublePhaseInteractionComponent*            InteractionComponent;                                     // 0x04A0(0x0008) (Edit, ExportObject, ZeroConstructor, DisableEditOnInstance, EditConst, InstancedReference, IsPlainOldData)
	TWeakObjectPtr<class ATslCharacter>                LastDriver;                                               // 0x04A8(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      UnknownData01[0x8];                                       // 0x04B0(0x0008) MISSED OFFSET
	struct FName                                       FreeFallFirstPersonCameraName;                            // 0x04B8(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	struct FName                                       FreeFallThirdPersonCameraName;                            // 0x04C0(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	float                                              FreeFallCameraPitchMin;                                   // 0x04C8(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	float                                              FreeFallCameraPitchMax;                                   // 0x04CC(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	float                                              ReleasingAltitude;                                        // 0x04D0(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              ForceReleasingAltitude;                                   // 0x04D4(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x18];                                      // 0x04D8(0x0018) MISSED OFFSET
	float                                              SweepMoveHeight;                                          // 0x04F0(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	float                                              LandingHeight;                                            // 0x04F4(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	float                                              LandingDuration;                                          // 0x04F8(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x4];                                       // 0x04FC(0x0004) MISSED OFFSET
	class UClass*                                      LandingBuff;                                              // 0x0500(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0xC];                                       // 0x0508(0x000C) MISSED OFFSET
	float                                              StuckCheckDistance;                                       // 0x0514(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              StuckCheckDuration;                                       // 0x0518(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData05[0xC];                                       // 0x051C(0x000C) MISSED OFFSET
	unsigned char                                      UnknownData06 : 1;                                        // 0x0528(0x0001)
	unsigned char                                      ForwardInputRepApplied : 1;                               // 0x0528(0x0001) (Net, Transient)
	unsigned char                                      ForwardInputRepIsForward : 1;                             // 0x0528(0x0001) (Net, Transient)
	unsigned char                                      RightInputRepApplied : 1;                                 // 0x0528(0x0001) (Net, Transient)
	unsigned char                                      RightInputRepIsRight : 1;                                 // 0x0528(0x0001) (Net, Transient)
	unsigned char                                      bIsReleased : 1;                                          // 0x0528(0x0001) (Net, Transient)
	unsigned char                                      bIsDriven : 1;                                            // 0x0528(0x0001) (Net, Transient)
	unsigned char                                      UnknownData07[0x7];                                       // 0x0529(0x0007) MISSED OFFSET
	struct FSkinData                                   SkinData;                                                 // 0x0530(0x0020) (Net, Transient)
	struct FRotator                                    InitialRotation;                                          // 0x0550(0x000C) (Transient, IsPlainOldData)
	struct FVector                                     InitialVelocity;                                          // 0x055C(0x000C) (Transient, IsPlainOldData)
	struct FVector                                     RideSocketOffset;                                         // 0x0568(0x000C) (Net, Transient, IsPlainOldData)
	struct FVector                                     LeaveSocketOffset;                                        // 0x0574(0x000C) (Net, Transient, IsPlainOldData)
...
public:
	...
	unsigned char                                      UnknownData10[0x4];                                       // 0x079C(0x0004) MISSED OFFSET
...
public:
	...
	bool                                               bKoreanRating;                                            // 0x00A9(0x0001) (Edit, ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData03[0x2];                                       // 0x00AA(0x0002) MISSED OFFSET
	float                                              GameStateLogInterval;                                     // 0x00AC(0x0004) (Edit, ZeroConstructor, Config, IsPlainOldData)
	float                                              ServerStatLogInterval;                                    // 0x00B0(0x0004) (Edit, ZeroConstructor, Config, IsPlainOldData)
	float                                              CharacterPositionLogInterval;                             // 0x00B4(0x0004) (Edit, ZeroConstructor, Config, IsPlainOldData)
	float                                              DestructibleComponentMaxDrawDistance;                     // 0x00B8(0x0004) (Edit, ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData04[0x4];                                       // 0x00BC(0x0004) MISSED OFFSET
	class UClass*                                      CharacterClassToPlay;                                     // 0x00C0(0x0008) (Edit, ZeroConstructor, Config, IsPlainOldData)
	TArray<struct FBoneBinding>                        BoneMapping;                                              // 0x00C8(0x0010) (Edit, ZeroConstructor, Config)
	TArray<struct FStringAssetReference>               TestVehicleClasses;                                       // 0x00D8(0x0010) (Edit, ZeroConstructor, Config)
	TArray<struct FStringAssetReference>               TestFloatingVehicleClasses;                               // 0x00E8(0x0010) (Edit, ZeroConstructor, Config)
	TArray<struct FChineseLicensingDefaultCustomizeData> ChineseLicensingDefaultCustomizeData;                     // 0x00F8(0x0010) (Edit, ZeroConstructor, Config)
	float                                              StoppedWheeledVehicleSpeedThreshold;                      // 0x0108(0x0004) (Edit, ZeroConstructor, Config, IsPlainOldData)
	float                                              StoppedFloatingVehicleSpeedThreshold;                     // 0x010C(0x0004) (Edit, ZeroConstructor, Config, IsPlainOldData)
	float                                              LastDriverDuration;                                       // 0x0110(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Config, IsPlainOldData)
	float                                              InteractableDistanceToleranceOnDedicatedServer;           // 0x0114(0x0004) (Edit, ZeroConstructor, Config, IsPlainOldData)
	float                                              InteractableDistance_ItemDefault;                         // 0x0118(0x0004) (Edit, ZeroConstructor, Config, IsPlainOldData)
	float                                              InteractableSpeed_ItemDefault;                            // 0x011C(0x0004) (Edit, ZeroConstructor, Config, IsPlainOldData)
	struct FInteractionCollisionData                   InteractionCollisionForFPS;                               // 0x0120(0x0014) (Edit, Config)
	struct FInteractionCollisionData                   InteractionCollisionForTPS;                               // 0x0134(0x0014) (Edit, Config)
	bool                                               bPreventFinishMatchInPIE;                                 // 0x0148(0x0001) (Edit, ZeroConstructor, Config, IsPlainOldData)
	bool                                               bEnableInitialItemDonator;                                // 0x0149(0x0001) (Edit, ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData05[0x2];                                       // 0x014A(0x0002) MISSED OFFSET
	float                                              InventoryMaxSpaceDefault;                                 // 0x014C(0x0004) (Edit, ZeroConstructor, Config, IsPlainOldData)
	class UTexture*                                    ErrorIconTexture;                                         // 0x0150(0x0008) (ZeroConstructor, IsPlainOldData)
	class UTexture*                                    LoadingIconTexture;                                       // 0x0158(0x0008) (ZeroConstructor, IsPlainOldData)
	TArray<class UObject*>                             AssetsForPackageIntegrity;                                // 0x0160(0x0010) (ZeroConstructor)
	float                                              UICrosshairDistance;                                      // 0x0170(0x0004) (Edit, ZeroConstructor, Config, IsPlainOldData)
	float                                              UICrosshairInterpSpeed;                                   // 0x0174(0x0004) (Edit, ZeroConstructor, Config, IsPlainOldData)
	float                                              UICrosshairDisableDistance;                               // 0x0178(0x0004) (Edit, ZeroConstructor, Config, IsPlainOldData)
	float                                              BallisticDragScale;                                       // 0x017C(0x0004) (Edit, ZeroConstructor, Config, IsPlainOldData)
	float                                              BallisticDropScale;                                       // 0x0180(0x0004) (Edit, ZeroConstructor, Config, IsPlainOldData)
	float                                              BallisticMOAScale;                                        // 0x0184(0x0004) (Edit, ZeroConstructor, Config, IsPlainOldData)
	float                                              RecoilControlScale;                                       // 0x0188(0x0004) (Edit, ZeroConstructor, Config, IsPlainOldData)
	float                                              RecoilAnimScale;                                          // 0x018C(0x0004) (Edit, ZeroConstructor, Config, IsPlainOldData)
	float                                              GameTimeMultiplier;                                       // 0x0190(0x0004) (Edit, ZeroConstructor, Config, IsPlainOldData)
	bool                                               AimOffsetRayCast;                                         // 0x0194(0x0001) (Edit, ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData06[0x3];                                       // 0x0195(0x0003) MISSED OFFSET
	float                                              MeleeWeaponPitchMin;                                      // 0x0198(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Config, IsPlainOldData)
	float                                              MeleeWeaponPitchMax;                                      // 0x019C(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Config, IsPlainOldData)
	bool                                               EnableThrowLagCompensation;                               // 0x01A0(0x0001) (Edit, ZeroConstructor, Config, IsPlainOldData)
	bool                                               FullRecoilRecovery;                                       // 0x01A1(0x0001) (Edit, ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData07[0x2];                                       // 0x01A2(0x0002) MISSED OFFSET
	struct FLevelLoadingBoostParameters                LevelLoadingBoostParameters;                              // 0x01A4(0x0010) (Edit, Config)
	unsigned char                                      UnknownData08[0x4];                                       // 0x01B4(0x0004) MISSED OFFSET
	TArray<struct FString>                             ErangelIgnoreWeatherIds;                                  // 0x01B8(0x0010) (Edit, ZeroConstructor, Config)
	TArray<struct FNearClippingValue>                  NearClippingValues;                                       // 0x01C8(0x0010) (ZeroConstructor, Config)
	TArray<struct FTslGame_FCustomizableCategoryData>  CustomizableCategoryData;                                 // 0x01D8(0x0010) (Edit, ZeroConstructor, Config)
	TArray<struct FCustomizableActionName>             CustomizableActionNames;                                  // 0x01E8(0x0010) (Edit, ZeroConstructor, Config)
	TArray<struct FTslGame_FCustomizableAxisName>      CustomizableAxisNames;                                    // 0x01F8(0x0010) (Edit, ZeroConstructor, Config)
	TArray<struct FCustomizableMouseSensitiveName>     CustomizableMouseSensitiveNames;                          // 0x0208(0x0010) (Edit, ZeroConstructor, Config)
	TArray<struct FCustomizableGamePadSensitiveName>   CustomizableGamePadSensitiveNames;                        // 0x0218(0x0010) (Edit, ZeroConstructor, Config)
	TArray<struct FSurportQualityLevel>                SupportedQualityLevels;                                   // 0x0228(0x0010) (Edit, ZeroConstructor, Config)
	TArray<struct FScreenResolution>                   SupportedScreenResolutions;                               // 0x0238(0x0010) (Edit, ZeroConstructor, Config)
	struct FStringAssetReference                       MouseSensitivityCurve;                                    // 0x0248(0x0010) (Edit, Config)
	struct FStringAssetReference                       GammaCurve;                                               // 0x0258(0x0010) (Edit, Config)
	TArray<struct FColorBlindType>                     ColorBlindTypes;                                          // 0x0268(0x0010) (Edit, ZeroConstructor, Config)
	TArray<struct FPresetColor>                        CrosshairColors;                                          // 0x0278(0x0010) (Edit, ZeroConstructor, Config)
	TArray<struct FKeyInputModeName>                   KeyInputModeNames;                                        // 0x0288(0x0010) (Edit, ZeroConstructor, Config)
	TArray<struct FUiType>                             MiniMapTypeList;                                          // 0x0298(0x0010) (Edit, ZeroConstructor, Config)
	float                                              MinimumScreenResolutionRatio;                             // 0x02A8(0x0004) (Edit, ZeroConstructor, Config, IsPlainOldData)
	struct FScreenResolution                           MinimumScreenResolution;                                  // 0x02AC(0x0008) (Edit, Config)
	unsigned char                                      UnknownData09[0x4];                                       // 0x02B4(0x0004) MISSED OFFSET
	TArray<struct FTeamColorAndIcon>                   OverrideMarkerColorAndIcons;                              // 0x02B8(0x0010) (Edit, ZeroConstructor, Config)
	float                                              PunchClientHitLeeway_Attacker;                            // 0x02C8(0x0004) (Edit, ZeroConstructor, Config, IsPlainOldData)
	float                                              PunchClientHitLeeway_Victim;                              // 0x02CC(0x0004) (Edit, ZeroConstructor, Config, IsPlainOldData)
	float                                              PunchClientHitLeeway_VictimInPlace;                       // 0x02D0(0x0004) (Edit, ZeroConstructor, Config, IsPlainOldData)
	float                                              ClientSideHitLeeway;                                      // 0x02D4(0x0004) (Edit, ZeroConstructor, Config, IsPlainOldData)
	float                                              ClientSideHitLeewayInPlace;                               // 0x02D8(0x0004) (Edit, ZeroConstructor, Config, IsPlainOldData)
	float                                              LogClientSideHitLeeway;                                   // 0x02DC(0x0004) (Edit, ZeroConstructor, Config, IsPlainOldData)
	float                                              ClientSideOriginDistanceLeeway;                           // 0x02E0(0x0004) (Edit, ZeroConstructor, Config, IsPlainOldData)
	float                                              ClientSideOriginDistanceLeewayInPlace;                    // 0x02E4(0x0004) (Edit, ZeroConstructor, Config, IsPlainOldData)
	float                                              ClientSideOriginDistanceMax;                              // 0x02E8(0x0004) (Edit, ZeroConstructor, Config, IsPlainOldData)
	float                                              TravelDistanceLeeway;                                     // 0x02EC(0x0004) (Edit, ZeroConstructor, Config, IsPlainOldData)
	float                                              AllowedHitLag;                                            // 0x02F0(0x0004) (Edit, ZeroConstructor, Config, IsPlainOldData)
	float                                              LogMinHitLag;                                             // 0x02F4(0x0004) (Edit, ZeroConstructor, Config, IsPlainOldData)
	float                                              HackDetectionSpeed;                                       // 0x02F8(0x0004) (Edit, ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData10[0x4];                                       // 0x02FC(0x0004) MISSED OFFSET
	TArray<struct FOverrideScalability>                OverrideScalabilities;                                    // 0x0300(0x0010) (Edit, ZeroConstructor, Config)
	float                                              FakeDoorBlockMaxY;                                        // 0x0310(0x0004) (Edit, ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData11[0x4];                                       // 0x0314(0x0004) MISSED OFFSET
	TArray<struct FReportCauseData>                    ReportCauses;                                             // 0x0318(0x0010) (Edit, ZeroConstructor, Config)
	TArray<struct FSubjectToReport>                    SubjectToReport;                                          // 0x0328(0x0010) (Edit, ZeroConstructor, Config)
	float                                              FreelookRecoveryInterpSpeed;                              // 0x0338(0x0004) (Edit, ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData12[0x4];                                       // 0x033C(0x0004) MISSED OFFSET
	TMap<struct FName, float>                          GamepadSensitiveMultiplier;                               // 0x0340(0x0050) (Edit, ZeroConstructor, Config)
	float                                              GamePadInnerDeadZone;                                     // 0x0390(0x0004) (Edit, ZeroConstructor, Config, IsPlainOldData)
	float                                              GamePadOutDeadZoneAcceleration;                           // 0x0394(0x0004) (Edit, ZeroConstructor, Config, IsPlainOldData)
	float                                              GamePadOutMaxAxisValue;                                   // 0x0398(0x0004) (Edit, ZeroConstructor, Config, IsPlainOldData)
	float                                              GamePadAccelerationStandardFps;                           // 0x039C(0x0004) (Edit, ZeroConstructor, Config, IsPlainOldData)
	float                                              AimAssistDecisionRadius;                                  // 0x03A0(0x0004) (Edit, ZeroConstructor, Config, IsPlainOldData)
	bool                                               bApplyInputValue;                                         // 0x03A4(0x0001) (Edit, ZeroConstructor, Config, IsPlainOldData)
	bool                                               bIgnorePadSensitive;                                      // 0x03A5(0x0001) (Edit, ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData13[0x2];                                       // 0x03A6(0x0002) MISSED OFFSET
	float                                              InsensitiveZone;                                          // 0x03A8(0x0004) (Edit, ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData14[0x4];                                       // 0x03AC(0x0004) MISSED OFFSET
	TArray<struct FAimAssistData>                      AimCameraAssists;                                         // 0x03B0(0x0010) (Edit, ZeroConstructor, Config)
	TArray<struct FAimAssistData>                      ADSCameraAssists;                                         // 0x03C0(0x0010) (Edit, ZeroConstructor, Config)
	TArray<struct FAimAssistData>                      Scope2XCameraAssists;                                     // 0x03D0(0x0010) (Edit, ZeroConstructor, Config)
	TArray<struct FAimAssistData>                      Scope4XCameraAssists;                                     // 0x03E0(0x0010) (Edit, ZeroConstructor, Config)
	TArray<struct FAimAssistData>                      Scope8XCameraAssists;                                     // 0x03F0(0x0010) (Edit, ZeroConstructor, Config)
	TArray<struct FAimAssistData>                      Scope15XCameraAssists;                                    // 0x0400(0x0010) (Edit, ZeroConstructor, Config)
	bool                                               bIsESports;                                               // 0x0410(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData15[0x7];                                       // 0x0411(0x0007) MISSED OFFSET
	struct FStringAssetReference                       DialogUMGWidgetClassStringAssetReference;                 // 0x0418(0x0010) (Edit, Config)
	unsigned char                                      UnknownData16[0x50];                                      // 0x0428(0x0050) MISSED OFFSET
	class UCurveFloat*                                 LoadedMouseSensitivityCurve;                              // 0x0478(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
	class UCurveFloat*                                 LoadedGammaCurve;                                         // 0x0480(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
	class UTextureRenderTarget2D*                      CharacterStudioRenderTarget;                              // 0x0488(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
	TArray<struct FAnimatableCustomizableObjectData>   AnimatableCustomizableDatas;                              // 0x0490(0x0010) (Edit, ZeroConstructor, Config)
	TMap<struct FName, float>                          NotifyDistanceLimitMap;                                   // 0x04A0(0x0050) (Edit, ZeroConstructor)
...
public:
	...
	unsigned char                                      UnknownData01[0xD0];                                      // 0x01C0(0x00D0) MISSED OFFSET
	class UClass*                                      LobbyWidgetClass;                                         // 0x0290(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x148];                                     // 0x0298(0x0148) MISSED OFFSET
	class ULobbyWidget*                                LobbyWidget;                                              // 0x03E0(0x0008) (ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData)
	unsigned char                                      UnknownData03[0xA8];                                      // 0x03E8(0x00A8) MISSED OFFSET
	TArray<struct FReplayKillEventItem>                ReplayKillEventItems;                                     // 0x0490(0x0010) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
	struct FScriptMulticastDelegate                    OnEnumerateReplayKillEventsDone;                          // 0x04A0(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData04[0xA0];                                      // 0x04B0(0x00A0) MISSED OFFSET
	TArray<struct FReplayGroggyEventItem>              ReplayGroggyEventItems;                                   // 0x0550(0x0010) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
	struct FScriptMulticastDelegate                    OnEnumerateReplayGroggyEventsDone;                        // 0x0560(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData05[0x10];                                      // 0x0570(0x0010) MISSED OFFSET
	TArray<struct FReplayItem>                         ReplayItemList;                                           // 0x0580(0x0010) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
	unsigned char                                      UnknownData06[0x38];                                      // 0x0590(0x0038) MISSED OFFSET
	struct FScriptMulticastDelegate                    OnGetReplayListDone;                                      // 0x05C8(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnGotoTimelineDone;                                       // 0x05D8(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnRecordStarted;                                          // 0x05E8(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnReplayProblem;                                          // 0x05F8(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnDownloadZippedReplayProgressDelegate;                   // 0x0608(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnDownloadZippedReplayCompleteDelegate;                   // 0x0618(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData07[0x28];                                      // 0x0628(0x0028) MISSED OFFSET
	int                                                MaxReplaysForNullStreamer;                                // 0x0650(0x0004) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	int                                                NumReplaysForNullStreamer;                                // 0x0654(0x0004) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	int                                                NumReplaysToKeepForNullStreamer;                          // 0x0658(0x0004) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData08[0x4];                                       // 0x065C(0x0004) MISSED OFFSET
	struct FScriptMulticastDelegate                    OnKeepAndDeleteOldestReplaysDoneDelegate;                 // 0x0660(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData09[0x10];                                      // 0x0670(0x0010) MISSED OFFSET
	class UGameEventObserver*                          GameEventObserver;                                        // 0x0680(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      UnknownData10[0x28];                                      // 0x0688(0x0028) MISSED OFFSET
	struct FTslReplaySummary                           ReplaySummaryForPlayback;                                 // 0x06B0(0x0080) (BlueprintVisible, BlueprintReadOnly)
	struct FScriptMulticastDelegate                    OnGetReplaySummaryDone;                                   // 0x0730(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	bool                                               bIsStartedFromReplayListMap;                              // 0x0740(0x0001) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData11[0x7];                                       // 0x0741(0x0007) MISSED OFFSET
	class ATslPlayerState*                             CachedDemoPlayerState;                                    // 0x0748(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      UnknownData12[0x148];                                     // 0x0750(0x0148) MISSED OFFSET
	class UHighlightSession*                           HighlightSession;                                         // 0x0898(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      UnknownData13[0xF0];                                      // 0x08A0(0x00F0) MISSED OFFSET
...
{
public:
	class UClass*                                      WeaponType;                                               // 0x0B50(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData00[0x58];                                      // 0x0B58(0x0058) MISSED OFFSET
...
{
public:
	unsigned char                                      UnknownData00[0x20];                                      // 0x0B50(0x0020) MISSED OFFSET
...
public:
	...
	bool                                               bEnableObserverInPIE;                                     // 0x04E0(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	...
	int                                                EditorTestTeamMemberCount;                                // 0x054C(0x0004) (ZeroConstructor, Config, IsPlainOldData)
...
{
public:
	struct FProjectileWeaponData                       ProjectileConfig;                                         // 0x0AF0(0x0008) (Edit, DisableEditOnInstance)
...
{
public:
	struct FThrowableWeaponData                        ThrowableConfig;                                          // 0x07E0(0x00A0) (Edit, DisableEditOnInstance)
	unsigned char                                      UnknownData00[0x18];                                      // 0x0880(0x0018) MISSED OFFSET
	EThrowableState                                    ThrowableState;                                           // 0x0898(0x0001) (Net, ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      UnknownData01[0x7];                                       // 0x0899(0x0007) MISSED OFFSET
	struct FName                                       ThrowWeaponSocketName;                                    // 0x08A0(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	struct FVector                                     PawnMotionContributionMultiplier;                         // 0x08A8(0x000C) (Edit, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData02[0x4];                                       // 0x08B4(0x0004) MISSED OFFSET
	class ATslParticle*                                CookingEffect;                                            // 0x08B8(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
	class AActor*                                      RingAttachment;                                           // 0x08C0(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
...
public:
	...
	class USpringArmComponent*                         FreeCameraSpringArmComponent;                             // 0x0460(0x0008) (Edit, ExportObject, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData)
	class UCameraComponent*                            FreeCameraComponent;                                      // 0x0468(0x0008) (Edit, ExportObject, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData)
	class USpringArmComponent*                         FollowCameraSpringArmComponent;                           // 0x0470(0x0008) (Edit, ExportObject, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData)
	class UCameraComponent*                            FollowCameraComponent;                                    // 0x0478(0x0008) (Edit, ExportObject, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData)
	class UArrowComponent*                             AudioListener;                                            // 0x0480(0x0008) (Edit, ExportObject, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData)
	unsigned char                                      UnknownData00[0x8];                                       // 0x0488(0x0008) MISSED OFFSET
	class UTslDeathCameraComponent*                    DeathCameraComponent;                                     // 0x0490(0x0008) (Edit, ExportObject, ZeroConstructor, DisableEditOnInstance, InstancedReference, IsPlainOldData)
	float                                              LocationUpdateIntervalSeconds;                            // 0x0498(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x049C(0x0004) MISSED OFFSET
	float                                              LimitMinFreeCamFov;                                       // 0x04A0(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              LimitMaxFreeCamFov;                                       // 0x04A4(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData02[0x10];                                      // 0x04A8(0x0010) MISSED OFFSET
	float                                              FollowCameraZoomSpeed;                                    // 0x04B8(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              LimitTargetArmLength;                                     // 0x04BC(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              SpectatableCheckLength;                                   // 0x04C0(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              SpectatableCheckScreenRatio;                              // 0x04C4(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData03[0x18];                                      // 0x04C8(0x0018) MISSED OFFSET
	class UClass*                                      OutlineEffectClass;                                       // 0x04E0(0x0008) (ZeroConstructor, Config, IsPlainOldData)
	class ATslPostProcessEffect*                       OutlineEffect;                                            // 0x04E8(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
	TArray<struct FSavedObPos>                         ArrObPos_Erangel;                                         // 0x04F0(0x0010) (ZeroConstructor, Config)
	TArray<struct FSavedObPos>                         ArrObPos_Desert;                                          // 0x0500(0x0010) (ZeroConstructor, Config)
	unsigned char                                      UnknownData04[0x48];                                      // 0x0510(0x0048) MISSED OFFSET
	class UClass*                                      ReplayZoneEffectClass;                                    // 0x0558(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class UClass*                                      ReplayZoneAreaClass;                                      // 0x0560(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class ATslPostProcessEffect*                       ReplayZoneEffect;                                         // 0x0568(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
	class AActor*                                      ReplayZoneArea;                                           // 0x0570(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
	struct FScriptMulticastDelegate                    OnPlayerInfoDistanceDelegate;                             // 0x0578(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData05[0x58];                                      // 0x0588(0x0058) MISSED OFFSET
...
{
public:
	float                                              TrajectoryGravityZ;                                       // 0x0AF0(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              RecoilSpreadScale;                                        // 0x0AF4(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               FireAtViewPoint;                                          // 0x0AF8(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0AF9(0x0003) MISSED OFFSET
	float                                              DefaultTimerFrequency;                                    // 0x0AFC(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              CrouchSpreadModifier;                                     // 0x0B00(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              ProneSpreadModifier;                                      // 0x0B04(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              WalkSpread;                                               // 0x0B08(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              RunSpread;                                                // 0x0B0C(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              JumpSpread;                                               // 0x0B10(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x0B14(0x0004) MISSED OFFSET
	struct FTrajectoryWeaponData                       TrajectoryConfig;                                         // 0x0B18(0x0080) (Edit, DisableEditOnInstance)
	struct FRecoilInfo                                 RecoilInfo;                                               // 0x0B98(0x0068) (Edit, DisableEditOnInstance)
	class UClass*                                      ImpactTemplate;                                           // 0x0C00(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class UParticleSystem*                             TrailFX;                                                  // 0x0C08(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	TMap<float, class UClass*>                         UnderWaterTrailFXClassPerLength;                          // 0x0C10(0x0050) (Edit, ZeroConstructor, DisableEditOnInstance)
	struct FName                                       TrailTargetParam;                                         // 0x0C60(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData02[0x18];                                      // 0x0C68(0x0018) MISSED OFFSET
	float                                              WeaponSpread;                                             // 0x0C80(0x0004) (Net, ZeroConstructor, Transient, IsPlainOldData)
	float                                              RecoilModifier_Stand;                                     // 0x0C84(0x0004) (Net, ZeroConstructor, Transient, IsPlainOldData)
	float                                              RecoilModifier_Crouch;                                    // 0x0C88(0x0004) (Net, ZeroConstructor, Transient, IsPlainOldData)
	float                                              RecoilModifier_Prone;                                     // 0x0C8C(0x0004) (Net, ZeroConstructor, Transient, IsPlainOldData)
	float                                              VerticalRecoilMin;                                        // 0x0C90(0x0004) (Net, ZeroConstructor, Transient, IsPlainOldData)
	float                                              VerticalRecoilMax;                                        // 0x0C94(0x0004) (Net, ZeroConstructor, Transient, IsPlainOldData)
...
{
public:
	class UAkAudioEvent*                               AttackSoundAk;                                            // 0x07E0(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	TArray<struct FMeleeWeaponAnim>                    AttackAnims;                                              // 0x07E8(0x0010) (Edit, ZeroConstructor, DisableEditOnInstance)
	float                                              Damage;                                                   // 0x07F8(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              WeaponImpact;                                             // 0x07FC(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class UClass*                                      DamageType;                                               // 0x0800(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	EHitCheckType                                      HitCheckType;                                             // 0x0808(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0809(0x0003) MISSED OFFSET
	float                                              AllowedHitRangeLeeway;                                    // 0x080C(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class UClass*                                      ImpactTemplate;                                           // 0x0810(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class UCapsuleComponent*                           HitCapsuleComponent;                                      // 0x0818(0x0008) (Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData)
...
public:
	...
	struct FName                                       StabilizeBone_Low;                                        // 0x07D8(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	struct FName                                       StabilizeBone_High;                                       // 0x07E0(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class UCurveFloat*                                 Curve_Roll;                                               // 0x07E8(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class UCurveFloat*                                 Curve_RollReturn;                                         // 0x07F0(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class UCurveFloat*                                 Curve_Steer;                                              // 0x07F8(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class UCurveFloat*                                 Curve_Yaw;                                                // 0x0800(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class UCurveFloat*                                 Curve_Torque;                                             // 0x0808(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	struct FVector                                     StabStaticVector;                                         // 0x0810(0x000C) (Edit, DisableEditOnInstance, IsPlainOldData)
	struct FVector                                     StabStaticVectorKickstand;                                // 0x081C(0x000C) (Edit, DisableEditOnInstance, IsPlainOldData)
	struct FVector                                     StabNoDriverVector;                                       // 0x0828(0x000C) (Edit, DisableEditOnInstance, IsPlainOldData)
	struct FVector2D                                   StabX_Velocity_In;                                        // 0x0834(0x0008) (Edit, DisableEditOnInstance, IsPlainOldData)
	struct FVector2D                                   StabX_Velocity_Out;                                       // 0x083C(0x0008) (Edit, DisableEditOnInstance, IsPlainOldData)
	struct FVector2D                                   StabX_Pitch_In;                                           // 0x0844(0x0008) (Edit, DisableEditOnInstance, IsPlainOldData)
	struct FVector2D                                   StabX_Pitch_Out;                                          // 0x084C(0x0008) (Edit, DisableEditOnInstance, IsPlainOldData)
	struct FVector2D                                   StabZ_Velocity_In;                                        // 0x0854(0x0008) (Edit, DisableEditOnInstance, IsPlainOldData)
	struct FVector2D                                   StabZ_Velocity_Out;                                       // 0x085C(0x0008) (Edit, DisableEditOnInstance, IsPlainOldData)
	struct FVector2D                                   StabZ_Roll_In;                                            // 0x0864(0x0008) (Edit, DisableEditOnInstance, IsPlainOldData)
	struct FVector2D                                   StabZ_Roll_Out;                                           // 0x086C(0x0008) (Edit, DisableEditOnInstance, IsPlainOldData)
	struct FVector2D                                   StabZ_Pitch_In;                                           // 0x0874(0x0008) (Edit, DisableEditOnInstance, IsPlainOldData)
	struct FVector2D                                   StabZ_Pitch_Out;                                          // 0x087C(0x0008) (Edit, DisableEditOnInstance, IsPlainOldData)
	struct FVector2D                                   StabTorque_In;                                            // 0x0884(0x0008) (Edit, DisableEditOnInstance, IsPlainOldData)
	struct FVector2D                                   StabTorque_Out;                                           // 0x088C(0x0008) (Edit, DisableEditOnInstance, IsPlainOldData)
	float                                              StabTorque_ForceScalar;                                   // 0x0894(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	struct FVector2D                                   StabTorque_Pitch_In;                                      // 0x0898(0x0008) (Edit, DisableEditOnInstance, IsPlainOldData)
	struct FVector2D                                   StabTorque_Pitch_Out;                                     // 0x08A0(0x0008) (Edit, DisableEditOnInstance, IsPlainOldData)
	bool                                               bUseFlipping;                                             // 0x08A8(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData02[0x3];                                       // 0x08A9(0x0003) MISSED OFFSET
	float                                              FlippingForce;                                            // 0x08AC(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              InitialFlipTimer;                                         // 0x08B0(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              MinVelocityForFlipping;                                   // 0x08B4(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData03[0x4];                                       // 0x08B8(0x0004) MISSED OFFSET
	float                                              DefaultLinearDamp;                                        // 0x08BC(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              DefaultAngularDamp;                                       // 0x08C0(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              DefaultMAV;                                               // 0x08C4(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              ContactAlpha_RiseRate;                                    // 0x08C8(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              ContactAlpha_FallRate;                                    // 0x08CC(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              ContactAlpha_LowerClamp;                                  // 0x08D0(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	struct FVector2D                                   ContactAlpha_MapPitchIn;                                  // 0x08D4(0x0008) (Edit, DisableEditOnInstance, IsPlainOldData)
	struct FVector2D                                   ContactAlpha_MapRollIn;                                   // 0x08DC(0x0008) (Edit, DisableEditOnInstance, IsPlainOldData)
	float                                              ContactAlphaRemoteMultiplier;                             // 0x08E4(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	struct FVector2D                                   AirControlF_VelMap;                                       // 0x08E8(0x0008) (Edit, DisableEditOnInstance, IsPlainOldData)
	struct FVector2D                                   AirControlB_VelMap;                                       // 0x08F0(0x0008) (Edit, DisableEditOnInstance, IsPlainOldData)
	struct FVector2D                                   AirControlL_VelMap;                                       // 0x08F8(0x0008) (Edit, DisableEditOnInstance, IsPlainOldData)
	struct FVector2D                                   AirControlR_VelMap;                                       // 0x0900(0x0008) (Edit, DisableEditOnInstance, IsPlainOldData)
	struct FVector2D                                   AirControlQ_VelMap;                                       // 0x0908(0x0008) (Edit, DisableEditOnInstance, IsPlainOldData)
	struct FVector2D                                   AirControlE_VelMap;                                       // 0x0910(0x0008) (Edit, DisableEditOnInstance, IsPlainOldData)
	float                                              AirControl_FB_Torque;                                     // 0x0918(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              AirControl_LR_Torque;                                     // 0x091C(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              AirControl_QE_Torque;                                     // 0x0920(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               bStabilizeInAir;                                          // 0x0924(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData04[0x3];                                       // 0x0925(0x0003) MISSED OFFSET
	float                                              StabilizeAirPercentage;                                   // 0x0928(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              FC_PitchUp;                                               // 0x092C(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              FC_PitchDown;                                             // 0x0930(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               bUseAnchoring;                                            // 0x0934(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData05[0x3];                                       // 0x0935(0x0003) MISSED OFFSET
	float                                              MinImpulseForAnchorRelease;                               // 0x0938(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	struct FVector2D                                   DriverVelocityAngularDampingInMap;                        // 0x093C(0x0008) (Edit, DisableEditOnInstance, IsPlainOldData)
	struct FVector2D                                   DriverVelocityAngularDampingOutMap;                       // 0x0944(0x0008) (Edit, DisableEditOnInstance, IsPlainOldData)
	bool                                               bProcessCounterSteering;                                  // 0x094C(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               bProcessCounterSteerOnRemote;                             // 0x094D(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData06[0x2];                                       // 0x094E(0x0002) MISSED OFFSET
	float                                              CounterSteerAngularSpeedScalar;                           // 0x0950(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              CounterSteerScalar_Default;                               // 0x0954(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              CounterSteerScalar_NoThrottle;                            // 0x0958(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              CounterSteerScalar_Brake;                                 // 0x095C(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData07[0x40];                                      // 0x0960(0x0040) MISSED OFFSET
	bool                                               bKickstandStabilizeActive;                                // 0x09A0(0x0001) (Net, ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      UnknownData08[0xF];                                       // 0x09A1(0x000F) MISSED OFFSET
...
{
public:
	struct FVector                                     Sidecar_StabilizerHigh_StaticCOM;                         // 0x09B0(0x000C) (Edit, DisableEditOnInstance, IsPlainOldData)
