...
struct FBodyInstance
{
	...
	unsigned char                                      bGenerateWakeEvents : 1;                                  // 0x0074(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly)
	...
	unsigned char                                      bLockYRotation : 1;                                       // 0x0075(0x0001) (Edit)
	unsigned char                                      bLockZRotation : 1;                                       // 0x0076(0x0001) (Edit)
	unsigned char                                      bOverrideMaxAngularVelocity : 1;                          // 0x0076(0x0001) (Edit)
	unsigned char                                      UnknownData03[0x5];                                       // 0x0077(0x0005) MISSED OFFSET
	unsigned char                                      bUseAsyncScene : 1;                                       // 0x007C(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bOverrideMaxDepenetrationVelocity : 1;                    // 0x007C(0x0001) (Edit)
	unsigned char                                      bOverrideWalkableSlopeOnInstance : 1;                     // 0x007C(0x0001) (Edit)
	unsigned char                                      UnknownData04[0x3];                                       // 0x007D(0x0003) MISSED OFFSET
	float                                              MaxDepenetrationVelocity;                                 // 0x0080(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData05[0x8];                                       // 0x0084(0x0008) MISSED OFFSET
	float                                              MassInKgOverride;                                         // 0x008C(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	float                                              LinearDamping;                                            // 0x0090(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              AngularDamping;                                           // 0x0094(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FVector                                     CustomDOFPlaneNormal;                                     // 0x0098(0x000C) (Edit, IsPlainOldData)
	struct FVector                                     COMNudge;                                                 // 0x00A4(0x000C) (Edit, BlueprintVisible, IsPlainOldData)
	unsigned char                                      UnknownData06[0x10];                                      // 0x00B0(0x0010) MISSED OFFSET
	float                                              MassScale;                                                // 0x00C0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData07[0x14];                                      // 0x00C4(0x0014) MISSED OFFSET
	struct FWalkableSlopeOverride                      WalkableSlopeOverride;                                    // 0x00D8(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, IsPlainOldData)
	class UPhysicalMaterial*                           PhysMaterialOverride;                                     // 0x00E8(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	float                                              MaxAngularVelocity;                                       // 0x00F0(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	float                                              CustomSleepThresholdMultiplier;                           // 0x00F4(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	float                                              StabilizationThresholdMultiplier;                         // 0x00F8(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	float                                              PhysicsBlendWeight;                                       // 0x00FC(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                PositionSolverIterationCount;                             // 0x0100(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData08[0x2C];                                      // 0x0104(0x002C) MISSED OFFSET
	uint64_t                                           RigidActorSyncId;                                         // 0x0130(0x0008) (ZeroConstructor, IsPlainOldData)
	uint64_t                                           RigidActorAsyncId;                                        // 0x0138(0x0008) (ZeroConstructor, IsPlainOldData)
	int                                                VelocitySolverIterationCount;                             // 0x0140(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData09[0xF8];                                      // 0x0144(0x00F8) MISSED OFFSET
	ESleepFamily                                       SleepFamily;                                              // 0x023C(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<EDOFMode>                              DOFMode;                                                  // 0x023D(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<ECollisionEnabled>                     CollisionEnabled;                                         // 0x023E(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<ECollisionChannel>                     ObjectType;                                               // 0x023F(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
};
...
struct FPostProcessSettings
{
	...
	unsigned char                                      bOverride_BloomConvolutionPreFilter : 1;                  // 0x0008(0x0001) (Edit, BlueprintVisible)
	...
	unsigned char                                      bOverride_TslBlurIntensity : 1;                           // 0x0008(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bOverride_TslBlurScopeInnerEdge : 1;                      // 0x0008(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bOverride_TslBlurScopeOutterEdge : 1;                     // 0x0008(0x0001) (Edit, BlueprintVisible)
	...
	unsigned char                                      bOverride_HBAOPowerExponent : 1;                          // 0x000C(0x0001) (BlueprintVisible)
	unsigned char                                      bOverride_HBAORadius : 1;                                 // 0x000C(0x0001) (BlueprintVisible)
	unsigned char                                      bOverride_HBAOBias : 1;                                   // 0x000C(0x0001) (BlueprintVisible)
	unsigned char                                      bOverride_HBAODetailAO : 1;                               // 0x000C(0x0001) (BlueprintVisible)
	unsigned char                                      bOverride_HBAOBlurRadius : 1;                             // 0x000D(0x0001) (BlueprintVisible)
	unsigned char                                      bOverride_HBAOBlurSharpness : 1;                          // 0x000D(0x0001) (BlueprintVisible)
	unsigned char                                      bOverride_HBAOMaxViewDepth : 1;                           // 0x000D(0x0001) (BlueprintVisible)
	unsigned char                                      bOverride_HBAODepthSharpness : 1;                         // 0x000D(0x0001) (BlueprintVisible)
	...
	unsigned char                                      bOverride_LPVDirectionalOcclusionIntensity : 1;           // 0x000E(0x0001) (Edit)
	...
	unsigned char                                      bOverride_LPVSecondaryBounceIntensity : 1;                // 0x000F(0x0001) (Edit, BlueprintVisible)
	...
	unsigned char                                      bOverride_DepthOfFieldScopeSize : 1;                      // 0x0011(0x0001) (Edit, BlueprintVisible)
	...
	struct FVector                                     BloomConvolutionPreFilter;                                // 0x02A4(0x000C) (Edit, BlueprintVisible, IsPlainOldData)
	float                                              BloomConvolutionBufferScale;                              // 0x02B0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x4];                                       // 0x02B4(0x0004) MISSED OFFSET
	class UTexture*                                    BloomDirtMask;                                            // 0x02B8(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	float                                              TslBlurIntensity;                                         // 0x02D4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              TslBlurScopeInnerEdge;                                    // 0x02D8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              TslBlurScopeOutterEdge;                                   // 0x02DC(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              TslBlurDepthBlackPoint;                                   // 0x02E0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              TslBlurDepthWhitePoint;                                   // 0x02E4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              TslBlurDepthGamma;                                        // 0x02E8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bTslBlurUseBranching;                                     // 0x02EC(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x3];                                       // 0x02ED(0x0003) MISSED OFFSET
	struct FLinearColor                                AmbientCubemapTint;                                       // 0x02F0(0x0010) (Edit, BlueprintVisible, IsPlainOldData)
	float                                              AmbientCubemapIntensity;                                  // 0x0300(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData05[0x4];                                       // 0x0304(0x0004) MISSED OFFSET
	class UTextureCube*                                AmbientCubemap;                                           // 0x0308(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<EAutoExposureMethod>                   AutoExposureMethod;                                       // 0x0310(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData06[0x3];                                       // 0x0311(0x0003) MISSED OFFSET
	float                                              AutoExposureLowPercent;                                   // 0x0314(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              AutoExposureHighPercent;                                  // 0x0318(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              AutoExposureMinBrightness;                                // 0x031C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              AutoExposureMaxBrightness;                                // 0x0320(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              AutoExposureSpeedUp;                                      // 0x0324(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              AutoExposureSpeedDown;                                    // 0x0328(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              AutoExposureBias;                                         // 0x032C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	float                                              LensFlareIntensity;                                       // 0x0338(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FLinearColor                                LensFlareTint;                                            // 0x033C(0x0010) (Edit, BlueprintVisible, IsPlainOldData)
	float                                              LensFlareBokehSize;                                       // 0x034C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              LensFlareThreshold;                                       // 0x0350(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData07[0x4];                                       // 0x0354(0x0004) MISSED OFFSET
	class UTexture*                                    LensFlareBokehShape;                                      // 0x0358(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FLinearColor                                LensFlareTints[0x8];                                      // 0x0360(0x0010) (Edit, IsPlainOldData)
	...
	float                                              HBAOPowerExponent;                                        // 0x03EC(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              HBAORadius;                                               // 0x03F0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              HBAOBias;                                                 // 0x03F4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              HBAODetailAO;                                             // 0x03F8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<EHBAOBlurRadius>                       HBAOBlurRadius;                                           // 0x03FC(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData08[0x3];                                       // 0x03FD(0x0003) MISSED OFFSET
	float                                              HBAOBlurSharpness;                                        // 0x0400(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              HBAOMaxViewDepth;                                         // 0x0404(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              HBAODepthSharpness;                                       // 0x0408(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	unsigned char                                      AmbientOcclusionRadiusInWS : 1;                           // 0x0418(0x0001) (Edit, BlueprintVisible)
	...
	struct FLinearColor                                IndirectLightingColor;                                    // 0x0440(0x0010) (Edit, BlueprintVisible, IsPlainOldData)
	float                                              IndirectLightingIntensity;                                // 0x0450(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              ColorGradingIntensity;                                    // 0x0454(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UTexture*                                    ColorGradingLUT;                                          // 0x0458(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<EDepthOfFieldMethod>                   DepthOfFieldMethod;                                       // 0x0460(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData10[0x3];                                       // 0x0461(0x0003) MISSED OFFSET
	unsigned char                                      bMobileHQGaussian : 1;                                    // 0x0464(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      UnknownData11[0x3];                                       // 0x0465(0x0003) MISSED OFFSET
	float                                              DepthOfFieldFstop;                                        // 0x0468(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              DepthOfFieldSensorWidth;                                  // 0x046C(0x0004) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              DepthOfFieldFocalDistance;                                // 0x0470(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              DepthOfFieldDepthBlurAmount;                              // 0x0474(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              DepthOfFieldDepthBlurRadius;                              // 0x0478(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              DepthOfFieldFocalRegion;                                  // 0x047C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              DepthOfFieldNearTransitionRegion;                         // 0x0480(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              DepthOfFieldFarTransitionRegion;                          // 0x0484(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              DepthOfFieldScale;                                        // 0x0488(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              DepthOfFieldMaxBokehSize;                                 // 0x048C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              DepthOfFieldNearBlurSize;                                 // 0x0490(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              DepthOfFieldFarBlurSize;                                  // 0x0494(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UTexture*                                    DepthOfFieldBokehShape;                                   // 0x0498(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              DepthOfFieldOcclusion;                                    // 0x04A0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              DepthOfFieldColorThreshold;                               // 0x04A4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              DepthOfFieldSizeThreshold;                                // 0x04A8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	float                                              MotionBlurPerObjectSize;                                  // 0x04BC(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              LPVIntensity;                                             // 0x04C0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              LPVVplInjectionBias;                                      // 0x04C4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              LPVSize;                                                  // 0x04C8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              LPVSecondaryOcclusionIntensity;                           // 0x04CC(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              LPVSecondaryBounceIntensity;                              // 0x04D0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              LPVGeometryVolumeBias;                                    // 0x04D4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              LPVEmissiveInjectionIntensity;                            // 0x04D8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              LPVDirectionalOcclusionIntensity;                         // 0x04DC(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              LPVDirectionalOcclusionRadius;                            // 0x04E0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              LPVDiffuseOcclusionExponent;                              // 0x04E4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              LPVSpecularOcclusionExponent;                             // 0x04E8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              LPVDiffuseOcclusionIntensity;                             // 0x04EC(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              LPVSpecularOcclusionIntensity;                            // 0x04F0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              ScreenSpaceReflectionIntensity;                           // 0x04F4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              ScreenSpaceReflectionQuality;                             // 0x04F8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              ScreenSpaceReflectionMaxRoughness;                        // 0x04FC(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              LPVFadeRange;                                             // 0x0500(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              LPVDirectionalOcclusionFadeRange;                         // 0x0504(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              ScreenPercentage;                                         // 0x0508(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
struct FMinimalViewInfo
{
	...
	struct FVector2D                                   OffCenterProjectionOffset;                                // 0x0570(0x0008) (Edit, BlueprintVisible, DisableEditOnTemplate, Transient, EditConst, IsPlainOldData)
...
struct FMaterialInstanceBasePropertyOverrides
{
	...
	bool                                               bOverride_PrepassMask;                                    // 0x0003(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	...
	unsigned char                                      bPrepassMasked : 1;                                       // 0x0010(0x0001) (Edit)
...
{
	struct FIntPoint                                   TextureSize;                                              // 0x0000(0x0008) (Edit, IsPlainOldData)
	...
	bool                                               bNormalMap;                                               // 0x0014(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bMetallicMap;                                             // 0x0015(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x2];                                       // 0x0016(0x0002) MISSED OFFSET
	float                                              MetallicConstant;                                         // 0x0018(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bRoughnessMap;                                            // 0x001C(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x3];                                       // 0x001D(0x0003) MISSED OFFSET
	float                                              RoughnessConstant;                                        // 0x0020(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bSpecularMap;                                             // 0x0024(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x3];                                       // 0x0025(0x0003) MISSED OFFSET
	float                                              SpecularConstant;                                         // 0x0028(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bEmissiveMap;                                             // 0x002C(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bOpacityMap;                                              // 0x002D(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x2];                                       // 0x002E(0x0002) MISSED OFFSET
	float                                              OpacityConstant;                                          // 0x0030(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bAmbientOcclusionMap;                                     // 0x0034(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	...
	float                                              AmbientOcclusionConstant;                                 // 0x003C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bOpacityMaskMap;                                          // 0x0040(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData06[0x3];                                       // 0x0041(0x0003) MISSED OFFSET
	float                                              OpacityMaskConstant;                                      // 0x0044(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	struct FIntPoint                                   DiffuseTextureSize;                                       // 0x0048(0x0008) (Edit, IsPlainOldData)
	struct FIntPoint                                   NormalTextureSize;                                        // 0x0050(0x0008) (Edit, IsPlainOldData)
	struct FIntPoint                                   MetallicTextureSize;                                      // 0x0058(0x0008) (Edit, IsPlainOldData)
	struct FIntPoint                                   RoughnessTextureSize;                                     // 0x0060(0x0008) (Edit, IsPlainOldData)
	struct FIntPoint                                   SpecularTextureSize;                                      // 0x0068(0x0008) (Edit, IsPlainOldData)
	struct FIntPoint                                   EmissiveTextureSize;                                      // 0x0070(0x0008) (Edit, IsPlainOldData)
	struct FIntPoint                                   OpacityTextureSize;                                       // 0x0078(0x0008) (Edit, IsPlainOldData)
	struct FIntPoint                                   AmbientOcclusionTextureSize;                              // 0x0080(0x0008) (Edit, IsPlainOldData)
	struct FIntPoint                                   OpacityMaskTextureSize;                                   // 0x0088(0x0008) (Edit, IsPlainOldData)
	TEnumAsByte<EMaterialMergeType>                    MaterialMergeType;                                        // 0x0090(0x0001) (ZeroConstructor, IsPlainOldData)
	TEnumAsByte<EBlendMode>                            BlendMode;                                                // 0x0091(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
struct FSkeletalMeshOptimizationSettings
{
	...
	class UAnimSequence*                               BakePose;                                                 // 0x0168(0x0008) (ZeroConstructor, IsPlainOldData)
};
...
{
	struct FIntPoint                                   BaseColorMapSize;                                         // 0x0000(0x0008) (Edit, IsPlainOldData)
	bool                                               bNormalMap;                                               // 0x0008(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0009(0x0003) MISSED OFFSET
	struct FIntPoint                                   NormalMapSize;                                            // 0x000C(0x0008) (Edit, IsPlainOldData)
	float                                              MetallicConstant;                                         // 0x0014(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bMetallicMap;                                             // 0x0018(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x0019(0x0003) MISSED OFFSET
	struct FIntPoint                                   MetallicMapSize;                                          // 0x001C(0x0008) (Edit, IsPlainOldData)
	float                                              RoughnessConstant;                                        // 0x0024(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bRoughnessMap;                                            // 0x0028(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x3];                                       // 0x0029(0x0003) MISSED OFFSET
	struct FIntPoint                                   RoughnessMapSize;                                         // 0x002C(0x0008) (Edit, IsPlainOldData)
	float                                              SpecularConstant;                                         // 0x0034(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bSpecularMap;                                             // 0x0038(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x3];                                       // 0x0039(0x0003) MISSED OFFSET
	struct FIntPoint                                   SpecularMapSize;                                          // 0x003C(0x0008) (Edit, IsPlainOldData)
};
...
struct FMeshProxySettings
{
	...
	struct FMaterialSimplificationSettings             Material;                                                 // 0x00A4(0x0044) (Deprecated)
	bool                                               bCalculateCorrectLODModel;                                // 0x00E8(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x00E9(0x0003) MISSED OFFSET
	float                                              OverrideDistanceForLevelLOD;                              // 0x00EC(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              MergeDistance;                                            // 0x00F0(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              HardAngleThreshold;                                       // 0x00F4(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	int                                                LightMapResolution;                                       // 0x00F8(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bRecalculateNormals;                                      // 0x00FC(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bBakeVertexData;                                          // 0x00FD(0x0001) (ZeroConstructor, Deprecated, IsPlainOldData)
	bool                                               bUseLandscapeCulling;                                     // 0x00FE(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<ELandscapeCullingPrecision>            LandscapeCullingPrecision;                                // 0x00FF(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bAssignLODGroup;                                          // 0x0100(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x0101(0x0003) MISSED OFFSET
	int                                                LODGroupIndex;                                            // 0x0104(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bAggregateMeshes;                                         // 0x0108(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	EChartAggregationMode                              AggregatorMode;                                           // 0x0109(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	EPhysXAggregationMode                              PhysXAggregationMode;                                     // 0x010A(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bUseCustomHemisphere;                                     // 0x010B(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              MergeBoldness;                                            // 0x010C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              MaxTriangleSize;                                          // 0x0110(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
};
...
struct FGroupedSkeletalOptimizationSettings
{
	...
	struct FMeshProxySettings                          ProxySettings;                                            // 0x0178(0x0114) (Edit)
...
struct FSkeletalMeshLODInfo
{
	...
	struct FGroupedSkeletalOptimizationSettings        OptimizationSettings;                                     // 0x0258(0x0290) (Edit)
	TArray<struct FName>                               RemovedBones;                                             // 0x04E8(0x0010) (Edit, ZeroConstructor)
	struct FString                                     SourceImportFilename;                                     // 0x04F8(0x0010) (Edit, ZeroConstructor, EditConst)
	unsigned char                                      bHasPerLODVertexColors : 1;                               // 0x0508(0x0001)
...
struct FRadialDamageEvent : public FDamageEvent
{
	...
	struct FVector                                     Origin;                                                   // 0x002C(0x000C) (IsPlainOldData)
...
struct FMeshMergingSettings
{
	...
	unsigned char                                      UnknownData00[0x3];                                       // 0x0001(0x0003) MISSED OFFSET
	int                                                TargetLightMapResolution;                                 // 0x0004(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bImportVertexColors;                                      // 0x0008(0x0001) (ZeroConstructor, Deprecated, IsPlainOldData)
	bool                                               bPivotPointAtZero;                                        // 0x0009(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bMergePhysicsData;                                        // 0x000A(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bAssignLODGroup;                                          // 0x000B(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	int                                                LODGroupIndex;                                            // 0x000C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bMergeMaterials;                                          // 0x0010(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x0011(0x0003) MISSED OFFSET
	struct FMaterialProxySettings                      MaterialSettings;                                         // 0x0014(0x0094) (Edit)
	bool                                               bBakeVertexDataToMesh;                                    // 0x00A8(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bUseVertexDataForBakingMaterial;                          // 0x00A9(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bUseTextureBinning;                                       // 0x00AA(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bCalculateCorrectLODModel;                                // 0x00AB(0x0001) (ZeroConstructor, Deprecated, IsPlainOldData)
	EMeshLODSelectionType                              LODSelectionType;                                         // 0x00AC(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x3];                                       // 0x00AD(0x0003) MISSED OFFSET
	int                                                ExportSpecificLOD;                                        // 0x00B0(0x0004) (ZeroConstructor, Deprecated, IsPlainOldData)
	int                                                SpecificLOD;                                              // 0x00B4(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bUseLandscapeCulling;                                     // 0x00B8(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bExportNormalMap;                                         // 0x00B9(0x0001) (ZeroConstructor, Deprecated, IsPlainOldData)
	bool                                               bExportMetallicMap;                                       // 0x00BA(0x0001) (ZeroConstructor, Deprecated, IsPlainOldData)
	bool                                               bExportRoughnessMap;                                      // 0x00BB(0x0001) (ZeroConstructor, Deprecated, IsPlainOldData)
	bool                                               bExportSpecularMap;                                       // 0x00BC(0x0001) (ZeroConstructor, Deprecated, IsPlainOldData)
	unsigned char                                      UnknownData03[0x3];                                       // 0x00BD(0x0003) MISSED OFFSET
	int                                                MergedMaterialAtlasResolution;                            // 0x00C0(0x0004) (ZeroConstructor, Deprecated, IsPlainOldData)
...
struct FLevelSimplificationDetails
{
	...
	float                                              MergeBoldness;                                            // 0x000C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	EPhysXAggregationMode                              PhysXAggregationMode;                                     // 0x0010(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x0011(0x0003) MISSED OFFSET
	float                                              MaxTriangleSize;                                          // 0x0014(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	struct FMaterialSimplificationSettings             StaticMeshMaterial;                                       // 0x0018(0x0044) (Deprecated)
	struct FMaterialProxySettings                      StaticMeshMaterialSettings;                               // 0x005C(0x0094) (Edit)
	bool                                               bOverrideLandscapeExportLOD;                              // 0x00F0(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x3];                                       // 0x00F1(0x0003) MISSED OFFSET
	int                                                LandscapeExportLOD;                                       // 0x00F4(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	struct FMaterialSimplificationSettings             LandscapeMaterial;                                        // 0x00F8(0x0044) (Deprecated)
	struct FMaterialProxySettings                      LandscapeMaterialSettings;                                // 0x013C(0x0094) (Edit)
	bool                                               bBakeFoliageToLandscape;                                  // 0x01D0(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bBakeGrassToLandscape;                                    // 0x01D1(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bGenerateMeshNormalMap;                                   // 0x01D2(0x0001) (ZeroConstructor, Deprecated, IsPlainOldData)
	bool                                               bGenerateMeshMetallicMap;                                 // 0x01D3(0x0001) (ZeroConstructor, Deprecated, IsPlainOldData)
	bool                                               bGenerateMeshRoughnessMap;                                // 0x01D4(0x0001) (ZeroConstructor, Deprecated, IsPlainOldData)
	bool                                               bGenerateMeshSpecularMap;                                 // 0x01D5(0x0001) (ZeroConstructor, Deprecated, IsPlainOldData)
	bool                                               bGenerateLandscapeNormalMap;                              // 0x01D6(0x0001) (ZeroConstructor, Deprecated, IsPlainOldData)
	bool                                               bGenerateLandscapeMetallicMap;                            // 0x01D7(0x0001) (ZeroConstructor, Deprecated, IsPlainOldData)
	bool                                               bGenerateLandscapeRoughnessMap;                           // 0x01D8(0x0001) (ZeroConstructor, Deprecated, IsPlainOldData)
	bool                                               bGenerateLandscapeSpecularMap;                            // 0x01D9(0x0001) (ZeroConstructor, Deprecated, IsPlainOldData)
	bool                                               bUseLandscapeCulling;                                     // 0x01DA(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<ELandscapeCullingPrecision>            LandscapeCullingPrecision;                                // 0x01DB(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
};
...
struct FHierarchicalSimplification
{
	...
	unsigned char                                      UnknownData01[0x3];                                       // 0x0009(0x0003) MISSED OFFSET
	struct FMeshProxySettings                          ProxySetting;                                             // 0x000C(0x0114) (Edit)
	struct FMeshMergingSettings                        MergeSetting;                                             // 0x0120(0x00C8) (Edit)
...
struct FAnimMontageInstance
{
	...
	TArray<struct FAnimNotifyEvent>                    ActiveStateBranchingPoints;                               // 0x00F0(0x0010) (ZeroConstructor, Transient)
	float                                              Position;                                                 // 0x0100(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              PlayRate;                                                 // 0x0104(0x0004) (ZeroConstructor, IsPlainOldData)
	struct FAlphaBlend                                 Blend;                                                    // 0x0108(0x0038) (Transient)
	unsigned char                                      UnknownData04[0x20];                                      // 0x0140(0x0020) MISSED OFFSET
	int                                                DisableRootMotionCount;                                   // 0x0160(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
...
struct FGroupedStaticMeshOptimizationSettings
{
	...
	struct FMeshProxySettings                          ProxySettings;                                            // 0x0150(0x0114) (Edit)
...
struct FStaticMeshSourceModel
{
	...
	struct FMeshReductionSettings                      ReductionSettings;                                        // 0x0040(0x0148)
	...
	struct FGroupedStaticMeshOptimizationSettings      OptimizationSettings;                                     // 0x0238(0x0268) (Edit)
	float                                              LODDistance;                                              // 0x04A0(0x0004) (ZeroConstructor, Deprecated, IsPlainOldData)
	float                                              ScreenSize;                                               // 0x04A4(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
};
